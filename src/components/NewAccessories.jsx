  ...
  return (
    <div className='bg-white py-10'>
       <div className='mx-auto max-w-2xl px-4 py-16 sm:pt-14 lg:max-w-7xl lg:px-8'>
            ...
            <p className='font-mono text-sm text-center mt-3 md:px-56 text-gray-600'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam alias possimus consectetur ab beatae cum.</p>
